    ...
    <div className="flex justify-between sm:flex-col md:flex-row p-4 gap-8 sm:text-[12px] md:text-sm">
      <div>
        <div className="flex justify-between items-center sm:w-full">
          ...
          {skillIcons.map((skilledIcons, icons) => (
            <div
              title={skilledIcons.title}
              key={icons}
        ...
        <div className="text-justify w-full mt-4">
          ...
          <div className="mt-8 font-body font-bold">
            ...
            <div className="pt-4 pr-8">
              <p>Tamil</p>
              <div className="h-1 w-full bg-white bg-opacity-5 mt-2 rounded-full relative">
                <motion.div
                  initial={{ width: 0 }}
      ...
      <div>
        <div className="flex justify-between items-center sm:w-full">
          ...
          {skillIcons2.map((skilledIcons, icons) => (
            <div
              title={skilledIcons.title}
              key={icons}
              className="flex justify-center items-center bg-white h-10 w-10 rounded-full text-black text-xl"
        ...
        <div className="text-justify-between w-full mt-4">
          <p className="text-justify font-bold font-body tracking-wider transition-all ease-linear duration-100 delay-75">
            ...
            web apps. Analyze, Reasearch and Develop is the key to create the
            awesome projects! The demos are given here &nbsp;
